      ...
      if EMenu.Spells[i.spell.name]["Draw"..i.spell.name]:Value() then
		if i.sType == "Line" and not EMenu.Keys.DDraws:Value() then
			...
			if EMenu.Draws.DSPath:Value() then
				if i.jp then
					if GetDistance(myHero,i.jp) > i.spell.radius + myHero.boundingRadius then
						if EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 1 then
							DrawLine(TopD1.x,TopD1.y,TopD2.x,TopD2.y,0.75,ARGB(145,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD1.x,TopD1.y,BotD1.x,BotD1.y,0.75,ARGB(145,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD2.x,TopD2.y,BotD2.x,BotD2.y,0.75,ARGB(145,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(BotD1.x,BotD1.y,BotD2.x,BotD2.y,0.75,ARGB(145,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 2 then
							DrawLine(TopD1.x,TopD1.y,TopD2.x,TopD2.y,1,ARGB(155,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD1.x,TopD1.y,BotD1.x,BotD1.y,1,ARGB(155,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD2.x,TopD2.y,BotD2.x,BotD2.y,1,ARGB(155,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(BotD1.x,BotD1.y,BotD2.x,BotD2.y,1,ARGB(155,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 3 then
							DrawLine(TopD1.x,TopD1.y,TopD2.x,TopD2.y,1.25,ARGB(165,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD1.x,TopD1.y,BotD1.x,BotD1.y,1.25,ARGB(165,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD2.x,TopD2.y,BotD2.x,BotD2.y,1.25,ARGB(165,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(BotD1.x,BotD1.y,BotD2.x,BotD2.y,1.25,ARGB(165,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 4 then
							DrawLine(TopD1.x,TopD1.y,TopD2.x,TopD2.y,1.5,ARGB(175,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD1.x,TopD1.y,BotD1.x,BotD1.y,1.5,ARGB(175,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(TopD2.x,TopD2.y,BotD2.x,BotD2.y,1.5,ARGB(175,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							DrawLine(BotD1.x,BotD1.y,BotD2.x,BotD2.y,1.5,ARGB(175,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						end
						if EMenu.Draws.DSEW:Value() then
							if EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 1 then
								DrawLine(TopD3.x,TopD3.y,TopD4.x,TopD4.y,1.5,ARGB(225,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD3.x,TopD3.y,BotD3.x,BotD3.y,1.5,ARGB(225,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD4.x,TopD4.y,BotD4.x,BotD4.y,1.5,ARGB(225,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(BotD3.x,BotD3.y,BotD4.x,BotD4.y,1.5,ARGB(225,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))				
							elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 2 then
								DrawLine(TopD3.x,TopD3.y,TopD4.x,TopD4.y,2,ARGB(235,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD3.x,TopD3.y,BotD3.x,BotD3.y,2,ARGB(235,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD4.x,TopD4.y,BotD4.x,BotD4.y,2,ARGB(235,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(BotD3.x,BotD3.y,BotD4.x,BotD4.y,2,ARGB(235,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))				
							elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 3 then
								DrawLine(TopD3.x,TopD3.y,TopD4.x,TopD4.y,2.5,ARGB(245,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD3.x,TopD3.y,BotD3.x,BotD3.y,2.5,ARGB(245,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD4.x,TopD4.y,BotD4.x,BotD4.y,2.5,ARGB(245,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(BotD3.x,BotD3.y,BotD4.x,BotD4.y,2.5,ARGB(245,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))				
							elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 4 then
								DrawLine(TopD3.x,TopD3.y,TopD4.x,TopD4.y,3,ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD3.x,TopD3.y,BotD3.x,BotD3.y,3,ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(TopD4.x,TopD4.y,BotD4.x,BotD4.y,3,ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
								DrawLine(BotD3.x,BotD3.y,BotD4.x,BotD4.y,3,ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
							end
						end
					else
						if EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 1 then
		...
		elseif i.sType == "Circular" and not EMenu.Keys.DDraws:Value() then
			if EMenu.Draws.DSPath:Value() then
				if GetDistance(myHero,i.ePos) > i.spell.radius + myHero.boundingRadius then
					...
					elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 2 then
						DrawCircle(i.ePos,i.spell.radius,1,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
					elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 3 then
						DrawCircle(i.ePos,i.spell.radius,1.25,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
					elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 4 then
						DrawCircle(i.ePos,i.spell.radius,1.5,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
					end
					if EMenu.Draws.DSEW:Value() then
						if EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 1 then
							DrawCircle(i.ePos,i.spell.radius+EMenu.Advanced.ew:Value(),1.5,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))	
						elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 2 then
							DrawCircle(i.ePos,i.spell.radius+EMenu.Advanced.ew:Value(),2,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 3 then
							DrawCircle(i.ePos,i.spell.radius+EMenu.Advanced.ew:Value(),2.5,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						elseif EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 4 then
							DrawCircle(i.ePos,i.spell.radius+EMenu.Advanced.ew:Value(),3,EMenu.Draws.SQ:Value(),ARGB(255,51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),51*EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value(),255))
						end
					end
				else
					if EMenu.Spells[i.spell.name]["d"..i.spell.name]:Value() == 1 then
					...
					if GetDistance(i.ePos) > i.spell.range + myHero.boundingRadius then
						...
						if i.jp and GetDistance(myHero,i.jp) < i.spell.radius + myHero.boundingRadius and not i.safe and i.mpos then
							--if GetDistance(GetOrigin(myHero) + Vector(i.sPos-i.ePos):perpendicular(),jp) >= GetDistance(GetOrigin(myHero) + Vector(i.sPos-i.ePos):perpendicular2(),jp) then
								...
								self.patha2 = Vector(i.mpos) + Vector(Vector(i.mpos) - i.ePos):perpendicular():normalized() * ((i.spell.radius + myHero.boundingRadius)*1.1+EMenu.Advanced.ew:Value())
								if self.mposs2 and GetDistance(self.mposs2,self.patha) > GetDistance(self.mposs2,self.patha2) then
									if not MapPosition:inWall(self.patha2) then
											i.safe = Vector(i.mpos) + Vector(Vector(i.mpos) - i.ePos):perpendicular():normalized() * ((i.spell.radius + myHero.boundingRadius)*1.1+EMenu.Advanced.ew:Value())
										else 
